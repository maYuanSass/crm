...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row">
        ...
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="xyd" value="${(customer.xyd)!}"  placeholder="请输入信用级别">
            </div>
        </div>
    </div>
    <div class="layui-form-item layui-row">
        ...
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="phone" lay-verify="required" value="${(customer.phone)!}"  placeholder="请输入联系电话">
            </div>
        </div>
    </div>
    <div class="layui-form-item layui-row">
    ...
    <div class="layui-form-item layui-row">
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="webSite" value="${(customer.webSite)!}"  placeholder="请输入客户网站">
            </div>
        </div>
        <div class="layui-col-xs6">
